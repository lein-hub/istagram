                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-blueGray-700">Following list</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <tbody>
                            <tr v-for="user in users" :key="user.id">
                                <td @click="newChatChannel(user.id)" class="hover:bg-gray-200 border-t-0 px-6 align-middle border-l-0 border-r-0 text-md align-center flex whitespace-nowrap p-4">
